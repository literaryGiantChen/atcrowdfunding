package com.diu.crowd.constant;

/**
 * @author DIU
 * @date 2021/11/1 10:12
 */
public class CrowdConstant {

    public static final String MESSAGE_LOGIN_FAILED = "抱歉！您输入的账号或密码错误，请重新输入";
    public static final String MESSAGE_LOGIN_ACCT_ALREADY_IN_USE = "抱歉！您输入的账号以被其他用户使用，请重新输入";
    public static final String MESSAGE_LOGIN_ACCT_ALREADY_IN_PWD = "抱歉！您输入的密码为空，请认真填写信息";
    public static final String MESSAGE_ACCESS_FORBIDEN = "您好！请你先登录以后在访问";
