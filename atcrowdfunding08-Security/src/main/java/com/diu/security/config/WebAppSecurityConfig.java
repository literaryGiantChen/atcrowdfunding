package com.diu.security.config;
...
public class WebAppSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    public WebAppSecurityConfig(DataSource dataSource, MyUserDetailsService userDetailsService) {
...
//			.disable()								// 禁用CSRF功能
                ...
                .and()
                .rememberMe()            // 开启记住我功能
                .tokenRepository(tokenRepository) // 通过数据库存入相关的账号和密码，启动时访问数据库去判断是否存在该用户
        ;
    }
